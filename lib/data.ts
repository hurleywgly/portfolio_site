...
export const projects: Project[] = [
  ...
  },
  {
    ...
    technologyHighlights: "We implemented a modern service-oriented architecture, decomposing the monolith into focused services handling distinct business capabilities: \n\n Modular service architecture for subscriptions and billing • Enhanced API gateway with robust authentication • Enhanced API gateway with robust authentication • Improved data management with dedicated service databases • Flexible integration patterns supporting diverse partner requirements",
